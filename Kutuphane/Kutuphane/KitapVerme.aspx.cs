...
namespace Kutuphane
{
    public partial class KitapVerme : System.Web.UI.Page
    {
        ...
        protected string Donusum(String dosyaYolu)
        {
            ...
            OpenCvSharp.Mat s = Cv2.ImRead(@"C:\Users\gozde\Desktop\kitap\" + dosyaYolu);
            ...
            Cv2.ImWrite(@"C:\Users\gozde\source\repos\Kutuphane\Kutuphane\kitap3.jpg", gray);
            Cv2.Threshold(gray, thresh, 0, 255, ThresholdTypes.Otsu | ThresholdTypes.BinaryInv);
            Cv2.ImWrite(@"C:\Users\gozde\source\repos\Kutuphane\Kutuphane\kitap4.jpg", thresh);
            rectKernel = Cv2.GetStructuringElement(MorphShapes.Rect, new OpenCvSharp.Size(33, 33));
            Cv2.Dilate(thresh, dilation, rectKernel);
            Cv2.ImWrite(@"C:\Users\gozde\source\repos\Kutuphane\Kutuphane\kitap5.jpg", dilation);
            ...
            Cv2.ImWrite(@"C:\Users\gozde\source\repos\Kutuphane\Kutuphane\kitap6.jpg", s);
            var img = s;
            //var img = new OpenCvSharp.Mat("C:\\Users\\gozde\\source\\repos\\Kutuphane\\kitap6.jpg");
            var ocr = new TesseractEngine("C:\\Users\\gozde\\source\\repos\\Kutuphane\\packages\\Tesseract.3.3.0.\\tessdata", "eng", EngineMode.TesseractAndCube);
        ...
        {
            string dosya_yolu2 = @"C:\Users\gozde\Desktop\kontrol.txt";
            ...
            string dosya_yolu = @"C:\Users\gozde\Desktop\Yaz2.txt";
        ...
        protected void btn_yukle_Click(object sender, EventArgs e)
        {
            ...
            StreamWriter Yaz = new StreamWriter("C:\\Users\\gozde\\Desktop\\Yaz2.txt");
